...
Ports::Ports(polycube::service::Cube<Ports> &parent,
  ...
  */
  ...
  r_port value{
      ...
      .direction = static_cast<uint8_t>(direction_),
  };
...
PortsDirectionEnum Ports::getDirection() {
  return direction_;
}

void Ports::setDirection(const PortsDirectionEnum &value) {
  throw std::runtime_error("Ports::setDirection: Method not implemented");
}
